$(function() {
	...
	function show_detail(detail_data,test_id){
		...
		for (var i = 0; i < subjects_length; i++) {
			// 表格列表信息
			var list_tr='<tr><td exam_subject_id="'+detail_data.subjects[i].exam_subject_id+'" batch-id="'+detail_data.subjects[i].batch_id+'" data-id="'+detail_data.subjects[i].id+'" class="subject-name">'+ detail_data.subjects[i].name +'</td><td class="count">'+ detail_data.student_total +'</td><td class="operation"><a href="../yuejuan2.0_front/answer.html" class="set"><i class="iconfont">&#xe60f;</i>试卷设置</a><a href="javascript:;" class="sign"><i class="iconfont">&#xe612;</i>权限分配</a><a href="javascript:;" class="dele"><i class="iconfont">&#xe616;</i>删除科目</a><a class="look-paper"><i class="iconfont">&#xe61e;</i>查看试卷</a></td></tr>';
